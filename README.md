...
Overview, Performance, Network, Processes, Storage, and Power show live readings. Capabilities lists each standard collector and can turn it off. Settings can delete local history. Events lists discrete changes such as collector enablement and memory or thermal transitions. Live observations are also saved locally in SQLite under Application Support.
