...
The repository currently contains a SwiftUI dashboard shell with sample readings. It collects no telemetry, persists no data, and requests no permissions. The next implementation milestone is the telemetry domain model and its tests.
